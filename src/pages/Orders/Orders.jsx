...
const OrdersStatsDotsContainer = styled(Box)(({ theme }) => ({
  display: 'flex',
  justifyContent: 'center',
  alignItems: 'center',
  gap: '8px',
...
const OrdersStatsDot = styled(Box)(({ active, theme }) => ({
  ...
  return (
    <OrdersPageContainer>
      <OrdersContentWrapper>
        ...
        {/* Estadísticas */}
        <Box sx={{ mb: 4 }}>
          <OrdersStatsGrid ref={statsGridRef} onScroll={handleStatsScroll}>
            {stats.map((stat) => (
