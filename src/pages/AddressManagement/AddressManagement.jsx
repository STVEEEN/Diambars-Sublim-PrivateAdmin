...
const AddressStatsDotsContainer = styled(Box)(({ theme }) => ({
  display: 'flex',
  justifyContent: 'center',
  alignItems: 'center',
  gap: '8px',
...
const AddressStatsDot = styled(Box)(({ active, theme }) => ({
    ...
    <AddressPageContainer>
      <AddressContentWrapper>
        ...
        <AddressStatsContainer>
          <AddressStatsGrid ref={statsGridRef} onScroll={handleStatsScroll}>
            {stats.map((stat) => (
