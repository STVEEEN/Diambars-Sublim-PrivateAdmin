          ...
          <Autocomplete
            ...
            renderInput={(params) => (
              <TextField
                ...
                helperText={validationErrors.userId || "Busca por nombre, email, tel�fono o ID"}
                InputProps={{
                  ...params.InputProps,
                  startAdornment: (
                    <>
            ...
            noOptionsText={
              ...
              "No se encontraron usuarios. Intenta con otro t�rmino de b�squeda."
            }
            ...
            <AddressMapPicker
              ...
              onAddressDataChange={(addressData) => {
                ...
                if (addressData.isAutoPopulated) {
                  ...
                  // Limpiar errores de validación para campos auto-poblados
                  setValidationErrors(prev => ({
                    ...prev,
